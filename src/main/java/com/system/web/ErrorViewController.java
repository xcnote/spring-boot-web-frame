...
public class ErrorViewController implements ErrorController{
     ...
     */
	@Autowired
    public ErrorViewController(ErrorAttributes errorAttributes) {
    ...
    public ModelAndView errorHtml404(HttpServletRequest request,
        ...
        return build404ErrorPage(model);
    }
	...
	public static final ModelAndView buildDefaultErrorPage(Map<String, Object> model){
		log.error("request error. model:{}", model);
		return new ModelAndView("error", "info", "系统出现未知错误！");
	}
